...
export const supportTickets = [
  { id: "t1", subject: "Can't withdraw funds from wallet", userName: "Mohamed Ali", userEmail: "mohamed@example.com", userRole: "Investor", priority: "High", status: "Open", createdAt: "2026-04-28T09:00:00Z", message: "I've been trying to withdraw my funds for 3 days but the button doesn't work. I need this resolved urgently." },
  { id: "t2", subject: "Project approval taking too long", userName: "Ahmed Hassan", userEmail: "ahmed@example.com", userRole: "Founder", priority: "Medium", status: "Open", createdAt: "2026-04-27T14:30:00Z", message: "I submitted my project 2 weeks ago and it's still pending review. When can I expect a decision?" },
  { id: "t3", subject: "KYC verification failed incorrectly", userName: "Nour Ibrahim", userEmail: "nour@example.com", userRole: "Investor", priority: "High", status: "InProgress", createdAt: "2026-04-26T11:00:00Z", message: "My KYC was rejected but all my documents are valid. I've uploaded clear copies of my national ID.", adminReply: "We're reviewing your case. Please upload a new photo of your ID with better lighting." },
  { id: "t4", subject: "How to change my funding model?", userName: "Sara Mohamed", userEmail: "sara@example.com", userRole: "Founder", priority: "Low", status: "Resolved", createdAt: "2026-04-25T16:00:00Z", message: "Is it possible to change my project from Reward to Equity model after publishing?", adminReply: "You can change the funding model from your project settings before the campaign starts collecting investments." },
  { id: "t5", subject: "Payment failed during investment", userName: "Layla Adel", userEmail: "layla@example.com", userRole: "Investor", priority: "High", status: "Open", createdAt: "2026-04-28T15:00:00Z", message: "I tried to invest EGP 5,000 in a project but the payment failed and my wallet was still charged." },
  { id: "t6", subject: "Request to delete my account", userName: "Youssef Tarek", userEmail: "youssef@example.com", userRole: "Investor", priority: "Medium", status: "Open", createdAt: "2026-04-28T10:00:00Z", message: "I'd like to permanently delete my account and all associated data." },
];
