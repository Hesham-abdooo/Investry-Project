...
import LeftPanelSignup from "../../Components/Authentication/Signup/LeftPanelSignup";
...
const handleGoogleSuccess = ({ token, roles }) => {
  ...
  return (
    <div className="h-screen flex overflow-hidden">
      ...
      {/* Right Side */}
      <div className="w-full lg:w-1/2 flex flex-col bg-[#f5f6f8] overflow-y-auto">
        <div className="flex-1 flex items-center justify-center px-4 py-8">
          <div className="w-full max-w-120">
            <div
              className="bg-white rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.07)] border border-gray-100 px-8 sm:px-10 py-8"
            ...
            >
              ...
              <h2
                className="text-2xl font-bold text-[#1a2340] mb-1 text-center"
              ...
              <button
                ...
                disabled={loading}
                className="w-full text-white font-semibold py-3 mb-3 rounded-xl transition-all duration-200 text-sm cursor-pointer active:scale-[0.98] disabled:opacity-50 shadow-sm hover:shadow-md"
                style={{
            ...
            <p className="text-center text-xs text-gray-400 mt-8">
              By continuing, you agree to InvesTry's Terms of Service and
              Privacy Policy.
            </p>
          </div>
        </div>
